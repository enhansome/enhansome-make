...
* [CheckMake](https://github.com/mrtazz/checkmake) ⭐ 1,214 | 🐛 44 | 🌐 Go | 📅 2026-09-21
* [Bake](https://github.com/EbodShojaei/bake) ⭐ 763 | 🐛 6 | 🌐 Python | 📅 2026-07-22 - Python-based Makefile formatter and linter that enforces consistent formatting according to Makefile best practices
...
* [Just](https://github.com/casey/just) ⭐ 35,951 | 🐛 171 | 🌐 Rust | 📅 2026-09-22 (Rust) [HN](https://news.ycombinator.com/item?id=34315779)
* [Task](https://github.com/go-task/task) ⭐ 16,180 | 🐛 193 | 🌐 Go | 📅 2026-09-22 (Go)
* [Ninja](https://github.com/ninja-build/ninja) ⭐ 13,256 | 🐛 406 | 🌐 C++ | 📅 2026-09-20
* [Mage](https://github.com/magefile/mage) ⭐ 4,693 | 🐛 128 | 🌐 Go | 📅 2026-04-23 (Go)
...
* [ptethng/telescope-makefile](https://github.com/ptethng/telescope-makefile) ⚠️ Archived - Simple [telescope](https://github.com/nvim-telescope/telescope.nvim) ⭐ 19,793 | 🐛 464 | 🌐 Lua | 📅 2026-08-17 extension to run GNU Make targets in [Neovim](https://neovim.io)
